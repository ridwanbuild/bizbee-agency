...
export default function UpdateNews() {
  return (
    <div
      className=" max-w-5xl m-auto my-20 p-5 lg:p-8  
      bg-gradient-to-r from-red-500 to-orange-500 

      lg:rounded-2xl text-white lg:flex  items-center justify-between"
    >
      {/* LEFT TEXT SECTION */}
      <div className="md:w-1/2 space-y-4">
        ...
        {/* Heading */}
        <h1
          className="lg:text-4xl text-xl leading-tight font-bold 
      ...
      <div className="flex mt-10  rounded-full border border-gray-300 overflow-hidden shadow-sm">
        <input
          ...
          className="flex-1 py-2 ps-4 outline-none text-sm"
        />
